...
const navigationCategories: NavigationCategory[] = [
  {
    ...
    icon: HomeIcon,
    items: [
      { name: 'Overview', href: '/driver/dashboard', icon: HomeIcon },
      { name: 'Current Delivery', href: '/driver/current', icon: TruckIcon },
    ]
  },
  {
    name: 'Deliveries',
    icon: TruckIcon,
    items: [
      { name: 'Available Orders', href: '/driver/orders/available', icon: ClockIcon },
      { name: 'My Deliveries', href: '/driver/orders', icon: TruckIcon },
      { name: 'Delivery History', href: '/driver/orders/history', icon: DocumentTextIcon },
    ]
  },
  {
    name: 'Navigation',
    icon: MapPinIcon,
    items: [
      { name: 'Live Map', href: '/driver/map', icon: MapPinIcon },
      { name: 'Route Optimization', href: '/driver/routes', icon: MapPinIcon },
    ]
  },
  {
    name: 'Earnings',
    ...
    items: [
      { name: 'Earnings Overview', href: '/driver/earnings', icon: CurrencyDollarIcon },
      { name: 'Payment History', href: '/driver/earnings/history', icon: DocumentTextIcon },
      { name: 'Analytics', href: '/driver/analytics', icon: ChartBarIcon },
    ]
  },
  {
    name: 'Account',
    ...
    items: [
      ...
      { name: 'Vehicle Info', href: '/driver/vehicle', icon: TruckIcon },
...
export default function DriverSidebar({
  ...
  const isItemActive = (href: string) => {
    return pathname === href || (href === '/driver/dashboard' && pathname === '/driver');
  };
