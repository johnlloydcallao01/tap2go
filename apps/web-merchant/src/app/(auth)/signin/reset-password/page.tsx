                ...
                {isSuccess ? (
                  <div className="space-y-6">
                    ...
                    <button
                      type="button"
                      onClick={() => router.push('/signin')}
                      className="w-full bg-teal-600 hover:bg-teal-700 text-white py-3.5 px-6 rounded-xl font-semibold transition-all duration-200 shadow-lg hover:shadow-xl"
                    >
                      Sign In
                    </button>
                  </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-12 pr-12 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 transition-all duration-200 text-gray-900 bg-gray-50 focus:bg-white disabled:bg-gray-100 disabled:cursor-not-allowed placeholder:text-gray-400"
