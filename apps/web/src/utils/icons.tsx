...
import { IconName, CategoryName, CategoryIconConfig } from '@/types';
...
export const getIcon = (iconName: IconName): any => {
  const iconMap: Record<IconName, any> = {
    ...
    receipt: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5l-5-5 5-5v10z" />
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 3v18l2-2 2 2 2-2 2 2V3l-2 2-2-2-2 2-2-2z" />
      </svg>
    ),
    history: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
/**
 * Category icon mapping for category circles
 */
export const getCategoryIcon = (category: CategoryName): CategoryIconConfig => {
