...
export type OrderStatus = 'pending' | 'confirmed' | 'preparing' | 'ready' | 'driver_assigned' | 'picked_up' | 'out_for_delivery' | 'delivered' | 'cancelled' | 'refunded';
...
export declare const asIconComponent: (icon: any) => IconComponent;
