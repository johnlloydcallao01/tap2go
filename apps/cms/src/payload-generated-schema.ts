...
export const enum_recent_searches_scope = pgEnum('enum_recent_searches_scope', [
  'restaurants',
  'merchant_menu',
  'global',
])
export const enum_recent_searches_source = pgEnum('enum_recent_searches_source', [
  'web',
  'mobile',
  'unknown',
])
...
export const enum_notification_templates_default_channels = pgEnum(
  'enum_notification_templates_default_channels',
  ['in_app', 'email', 'push', 'sms'],
)
export const enum_notification_templates_domain = pgEnum('enum_notification_templates_domain', [
  'order',
  'account',
  'system',
  'marketing',
...
export const enum_notification_templates_severity = pgEnum('enum_notification_templates_severity', [
  'info',
  'warning',
  'critical',
])
export const enum_notification_events_domain = pgEnum('enum_notification_events_domain', [
  'order',
  'account',
  'system',
  'marketing',
...
export const enum_notification_events_origin = pgEnum('enum_notification_events_origin', [
  'automatic',
  'manual',
])
export const enum_notification_events_priority = pgEnum('enum_notification_events_priority', [
  'info',
  'warning',
  'critical',
])
...
export const enum_user_notifications_status = pgEnum('enum_user_notifications_status', [
  'unread',
  'read',
  'dismissed',
  'hidden',
...
export const recent_searches = pgTable(
  'recent_searches',
  {
    ...
    scope: enum_recent_searches_scope('scope').notNull().default('restaurants'),
    compositeKey: varchar('composite_key'),
    frequency: numeric('frequency').notNull().default('1'),
    source: enum_recent_searches_source('source').default('unknown'),
  ...
  (columns) => ({
    recent_searches_user_idx: index('recent_searches_user_idx').on(columns.user),
    recent_searches_composite_key_idx: uniqueIndex('recent_searches_composite_key_idx').on(
      columns.compositeKey,
    ),
    recent_searches_updated_at_idx: index('recent_searches_updated_at_idx').on(columns.updatedAt),
    recent_searches_created_at_idx: index('recent_searches_created_at_idx').on(columns.createdAt),
  }),
)
...
export const notification_templates_default_channels = pgTable(
  'notification_templates_default_channels',
  {
    order: integer('order').notNull(),
    parent: integer('parent_id').notNull(),
    value: enum_notification_templates_default_channels('value'),
    id: serial('id').primaryKey(),
  },
  (columns) => ({
    orderIdx: index('notification_templates_default_channels_order_idx').on(columns.order),
    parentIdx: index('notification_templates_default_channels_parent_idx').on(columns.parent),
    parentFk: foreignKey({
      columns: [columns['parent']],
      foreignColumns: [notification_templates.id],
      name: 'notification_templates_default_channels_parent_fk',
    }).onDelete('cascade'),
  }),
)
...
export const notification_templates = pgTable(
  'notification_templates',
  {
    ...
    domain: enum_notification_templates_domain('domain').notNull(),
    titleTemplate: varchar('title_template').notNull(),
    bodyTemplate: varchar('body_template').notNull(),
    severity: enum_notification_templates_severity('severity').notNull().default('info'),
    isActive: boolean('is_active').default(true),
  ...
  (columns) => ({
    notification_templates_type_key_idx: uniqueIndex('notification_templates_type_key_idx').on(
      columns.typeKey,
    ),
    notification_templates_created_by_idx: index('notification_templates_created_by_idx').on(
      columns.createdBy,
    ),
    notification_templates_updated_by_idx: index('notification_templates_updated_by_idx').on(
      columns.updatedBy,
    ),
    notification_templates_updated_at_idx: index('notification_templates_updated_at_idx').on(
      columns.updatedAt,
    ),
    notification_templates_created_at_idx: index('notification_templates_created_at_idx').on(
      columns.createdAt,
    ),
  }),
)
...
export const notification_events = pgTable(
  'notification_events',
  {
    id: serial('id').primaryKey(),
    typeKey: varchar('type_key').notNull(),
    domain: enum_notification_events_domain('domain').notNull(),
    ...
    origin: enum_notification_events_origin('origin').notNull().default('automatic'),
    triggeredBy: integer('triggered_by_id').references(() => users.id, {
      onDelete: 'set null',
    }),
    ...
    priority: enum_notification_events_priority('priority').notNull().default('info'),
  ...
  (columns) => ({
    notification_events_template_idx: index('notification_events_template_idx').on(
      columns.template,
    ),
    notification_events_triggered_by_idx: index('notification_events_triggered_by_idx').on(
      columns.triggeredBy,
    ),
    notification_events_updated_at_idx: index('notification_events_updated_at_idx').on(
      columns.updatedAt,
    ),
    notification_events_created_at_idx: index('notification_events_created_at_idx').on(
      columns.createdAt,
    ),
  }),
)
...
export const user_notifications = pgTable(
  'user_notifications',
  {
    ...
    notificationEvent: integer('notification_event_id')
      .notNull()
  ...
  (columns) => ({
    user_notifications_user_idx: index('user_notifications_user_idx').on(columns.user),
    user_notifications_notification_event_idx: index(
      'user_notifications_notification_event_idx',
    ).on(columns.notificationEvent),
    user_notifications_updated_at_idx: index('user_notifications_updated_at_idx').on(
      columns.updatedAt,
    ),
...
export const cart_items = pgTable(
  'cart_items',
  {
    ...
    merchantProduct: integer('merchant_product_id')
      .notNull()
    ...
    specialInstructions: varchar('special_instructions'),
    notesForRider: varchar('notes_for_rider'),
    itemHash: varchar('item_hash'),
    isAvailable: boolean('is_available').default(true),
    unavailableReason: varchar('unavailable_reason'),
  ...
  (columns) => ({
    cart_items_customer_idx: index('cart_items_customer_idx').on(columns.customer),
    cart_items_merchant_idx: index('cart_items_merchant_idx').on(columns.merchant),
    ...
    cart_items_updated_at_idx: index('cart_items_updated_at_idx').on(columns.updatedAt),
    cart_items_created_at_idx: index('cart_items_created_at_idx').on(columns.createdAt),
    customer_merchant_idx: index('customer_merchant_idx').on(columns.customer, columns.merchant),
    customer_itemHash_idx: index('customer_itemHash_idx').on(columns.customer, columns.itemHash),
...
export const payload_locked_documents_rels = pgTable(
  'payload_locked_documents_rels',
  {
    ...
    'recent-searchesID': integer('recent_searches_id'),
  ...
  (columns) => ({
    ...
    payload_locked_documents_rels_recent_searches_id_idx: index(
      'payload_locked_documents_rels_recent_searches_id_idx',
    ).on(columns['recent-searchesID']),
    ...
    payload_locked_documents_rels_notification_templates_id_idx: index(
      'payload_locked_documents_rels_notification_templates_id_idx',
    ).on(columns['notification-templatesID']),
    payload_locked_documents_rels_notification_events_id_idx: index(
      'payload_locked_documents_rels_notification_events_id_idx',
    ).on(columns['notification-eventsID']),
    ...
    'recent-searchesIdFk': foreignKey({
      columns: [columns['recent-searchesID']],
      foreignColumns: [recent_searches.id],
      name: 'payload_locked_documents_rels_recent_searches_fk',
    }).onDelete('cascade'),
    ...
    'notification-templatesIdFk': foreignKey({
      columns: [columns['notification-templatesID']],
      foreignColumns: [notification_templates.id],
      name: 'payload_locked_documents_rels_notification_templates_fk',
    }).onDelete('cascade'),
    'notification-eventsIdFk': foreignKey({
      columns: [columns['notification-eventsID']],
      foreignColumns: [notification_events.id],
      name: 'payload_locked_documents_rels_notification_events_fk',
    }).onDelete('cascade'),
    'user-notificationsIdFk': foreignKey({
...
export const relations_notification_templates_default_channels = relations(
  notification_templates_default_channels,
  ({ one }) => ({
    parent: one(notification_templates, {
      fields: [notification_templates_default_channels.parent],
      references: [notification_templates.id],
      relationName: 'defaultChannels',
    }),
  }),
)
export const relations_notification_templates = relations(
  notification_templates,
  ({ one, many }) => ({
    defaultChannels: many(notification_templates_default_channels, {
      relationName: 'defaultChannels',
    }),
    createdBy: one(users, {
      fields: [notification_templates.createdBy],
      references: [users.id],
      relationName: 'createdBy',
    }),
    updatedBy: one(users, {
      fields: [notification_templates.updatedBy],
      references: [users.id],
      relationName: 'updatedBy',
    }),
  }),
)
export const relations_notification_events = relations(notification_events, ({ one }) => ({
  template: one(notification_templates, {
    fields: [notification_events.template],
    references: [notification_templates.id],
    relationName: 'template',
  }),
  triggeredBy: one(users, {
    fields: [notification_events.triggeredBy],
    references: [users.id],
    relationName: 'triggeredBy',
  }),
}))
export const relations_user_notifications = relations(user_notifications, ({ one }) => ({
  ...
  notificationEvent: one(notification_events, {
    fields: [user_notifications.notificationEvent],
    references: [notification_events.id],
...
export const relations_cart_items = relations(cart_items, ({ one }) => ({
  customer: one(customers, {
    fields: [cart_items.customer],
    references: [customers.id],
    relationName: 'customer',
  }),
  merchant: one(merchants, {
    fields: [cart_items.merchant],
    references: [merchants.id],
  ...
  merchantProduct: one(merchant_products, {
    fields: [cart_items.merchantProduct],
    references: [merchant_products.id],
...
export const relations_payload_locked_documents_rels = relations(
  ...
  ({ one }) => ({
    ...
    'recent-searchesID': one(recent_searches, {
      fields: [payload_locked_documents_rels['recent-searchesID']],
      references: [recent_searches.id],
      relationName: 'recent-searches',
    }),
    ...
    'notification-eventsID': one(notification_events, {
      fields: [payload_locked_documents_rels['notification-eventsID']],
      references: [notification_events.id],
      relationName: 'notification-events',
    }),
...
type DatabaseSchema = {
  ...
  enum_recent_searches_scope: typeof enum_recent_searches_scope
  enum_recent_searches_source: typeof enum_recent_searches_source
  ...
  enum_notification_templates_default_channels: typeof enum_notification_templates_default_channels
  enum_notification_templates_domain: typeof enum_notification_templates_domain
  enum_notification_templates_severity: typeof enum_notification_templates_severity
  enum_notification_events_domain: typeof enum_notification_events_domain
  enum_notification_events_origin: typeof enum_notification_events_origin
  enum_notification_events_priority: typeof enum_notification_events_priority
  enum_user_notifications_channel: typeof enum_user_notifications_channel
  enum_user_notifications_status: typeof enum_user_notifications_status
  ...
  notification_templates_default_channels: typeof notification_templates_default_channels
  ...
  relations_notification_templates_default_channels: typeof relations_notification_templates_default_channels
