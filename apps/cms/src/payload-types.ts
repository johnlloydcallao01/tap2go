...
export interface NotificationTemplate {
  ...
  bodyTemplate: string;
  defaultChannels?: ('in_app' | 'email' | 'push' | 'sms')[] | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "notification-events".
 */
...
export interface UserNotification {
  id: number;
  user: number | User;
  notificationEvent: number | NotificationEvent;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "recent-views".
 */
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        ...
        value: number | NotificationEvent;
      } | null)
    | ({
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "notification-events_select".
 */
export interface NotificationEventsSelect<T extends boolean = true> {
  typeKey?: T;
  domain?: T;
  sourceEntityType?: T;
  sourceEntityId?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "recent-views_select".
 */
export interface RecentViewsSelect<T extends boolean = true> {
  user?: T;
  deviceId?: T;
  itemType?: T;
  merchant?: T;
