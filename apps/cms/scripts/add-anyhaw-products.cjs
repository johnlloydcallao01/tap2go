 ...
 *     - merchant_id = 24 (ANYHAW NI DADI)
 *     - product_id = the product created above
 *     - added_by = 'vendor'
 *
 * Usage:
 *   node scripts/add-anyhaw-products.cjs            # perform the insertion
 *   node scripts/add-anyhaw-products.cjs --dry-run  # print plan only
 *
 * The script is idempotent: products already owned by vendor 19 with the same
...
const VENDOR_ID = 19; // ANYHAW NI DADI
const MERCHANT_ID = 24; // ANYHAW NI DADI

const DRY_RUN = process.argv.includes('--dry-run');

// Product list: [name, category, price in PHP]
const PRODUCTS = [
  ['Chicken Sisig', 'Appetizers', 230.0],
  ['Chicken Sisig Meal', 'Best Meal Ever', 148.0],
  ['Sweet and Spicy Longganisa Meal', 'Best Meal Ever', 148.0],
  ['Liempo Rekado Meal', 'Best Meal Ever', 158.0],
  ['Sweet and Spicy Longganisa', 'Appetizers', 288.0],
  ['Liempo Rekado', 'All Time Peborit', 322.0],
  ['Spicy Roasted Half Chicken', 'Half Order Entree', 207.0],
  ['Classic Roasted Half Chicken', 'Half Order Entree', 207.0],
  ['Classic Roasted Whole Chicken', 'The Big 3 Entree', 403.0],
  ['Spicy Roasted Whole Chicken', 'The Big 3 Entree', 403.0],
  ['Pork Liempo', 'The Big 3 Entree', 288.0],
  ['Pork Belly Lechon', 'All Time Peborit', 633.0],
  ['Baby Back Ribs (Filipino style)', 'All Time Peborit', 667.0],
  ['Baby Back Ribs Filipino style (Half Slab)', 'Half Order Entree', 345.0],
  ['Ultimate Combo Experience (Half Chicken and half order of Pork Liempo with 2 Java rice)', 'Best Meal Ever', 389.0],
  ['Sisig Meal', 'Best Meal Ever', 148.0],
  ['Liempo Meal', 'Best Meal Ever', 148.0],
  ['Leg Part Meal', 'Best Meal Ever', 148.0],
  ['Pecho Part Meal', 'Best Meal Ever', 159.0],
  ['Roasted Yellow Fin Tail', 'Fishda for The Day', 377.0],
  ['Roasted Tilapia', 'Fishda for The Day', 173.0],
  ['Roasted Yellow Fin Tuna', 'Fishda for The Day', 518.0],
  ['Roasted Yellow Pampano', 'Fishda for The Day', 437.0],
  ['Sinugba Bangus', 'Fishda for The Day', 207.0],
  ['Crispy Cheesy Sisig (200 grams)', 'Appetizers', 230.0],
  ['The Best Atsara', 'Condiments', 41.0],
  ['mineral water 1000ml', 'Refreshment', 35.0],
  ['Mineral water 500 ml', 'Refreshment', 23.0],
  ['Mineral water', 'Refreshment', 12.0],
  ['Pancit Canton', 'Pancit Long Life', 148.0],
  ['Pancit Bato', 'Pancit Long Life', 159.0],
  ['Java Rice (Platter)', 'Java Rice', 115.0],
  ['Java Rice (single order)', 'Java Rice', 29.0],
  ['Leche Plan', 'Dessert', 41.0],
  ['Chili Garlic Sauce', 'Condiments', 92.0],
  ['Aregladong Suka', 'Condiments', 207.0],
];
