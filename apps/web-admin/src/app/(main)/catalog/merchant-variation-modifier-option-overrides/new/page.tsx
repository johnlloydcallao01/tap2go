...
function NewMerchantVariationModifierOptionOverrideContent() {
  ...
  const handleSuccess = async () => {
    // Bust the 3-min list cache BEFORE navigating back, otherwise /catalog/merchant-variation-modifier-option-overrides
    ...
    router.push('/catalog/merchant-variation-modifier-option-overrides')
  }
  return (
    <div className="space-y-6 py-5 px-2.5">
      ...
      <MerchantVariationModifierOptionOverrideForm onSuccess={handleSuccess} onCancel={handleBack} />
    </div>
  )
}
