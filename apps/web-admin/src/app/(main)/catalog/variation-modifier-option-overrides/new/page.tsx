...
function NewVariationModifierOptionOverrideSkeleton(){
  ...
  return (
    <div className="space-y-6 py-5 px-2.5">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">New variation modifier option override</h1>
...
export default function NewVariationModifierOptionOverridePage(){
  return (
    <ClientOnly fallback={<NewVariationModifierOptionOverrideSkeleton />}>
      <NewVariationModifierOptionOverrideContent />
    </ClientOnly>
  )
}
