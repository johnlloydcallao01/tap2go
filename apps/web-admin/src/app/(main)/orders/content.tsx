...
import {
  ShoppingBag, Receipt, Package, Truck, Store, Mail, Phone, CheckCircle, XCircle, Clock,
  Search, X, SlidersHorizontal, ChevronDown, Plus, RefreshCw, AlertCircle, Building,
  CalendarDays, Eye, Pencil, Trash2, ShieldCheck
} from 'lucide-react'
...
export function OrdersPageContent() {
  ...
  const avgVal = stats ? fmtCurrency(stats.avgOrderValue || 0) : ''
