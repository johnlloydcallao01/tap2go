  ...
  return (
    <div className="space-y-6 py-5 px-2.5">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">Edit coupon</h1>
          <p className="text-sm text-gray-500 dark:text-[#a1a1aa] font-mono">#{doc.id} • {doc.code}</p>
        </div>
      </div>
